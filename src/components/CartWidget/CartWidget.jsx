...
const CartWidget = () => {
    ...
    const {cartTotal, clear} = React.useContext(CartContext);
        ...
        <div className="d-flex text-center">
            ...
            {cartTotal() !== 0 ?
                <><Link to={"/cart"}>
                    ...
                    <span className="border border-3 rounded-circle " id="contador-carrito" style={stylesCarrito}>{cartTotal()}</span>
                </Link>
                    <button type="button" title="Vaciar Carrito" onClick={() => { clear() }}>
